...
namespace MvcDemoProject.Controllers
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source =.\SQLEXPRESS; Initial Catalog = MEDFAR_DEV_INTERVIEW; Integrated Security = True; MultipleActiveResultSets=True");
